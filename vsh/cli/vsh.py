...
@click.pass_context
def vsh(ctx, copy, create_only, dry_run, ephemeral, force, interactive, shell_completion, ls, no_pip, overwrite, path, python, remove, upgrade, verbose, version, name, command):
    if shell_completion:
